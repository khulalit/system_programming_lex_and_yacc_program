...
{
  "$end", "error", "$undefined", "letter", "digit", "newline", "operator",
  "minus", "ob", "cb", "'+'", "'-'", "'*'", "'/'", "$accept", "S", "E",
  "T", YY_NULLPTR
};
#endif
...
{
       9,    10,     9,     9,     2,    -4,    10,    -4,    -4,    27,
      29,    -4,    16,     9,    -4,    -4,    -4,    18,    33,    36,
       9,    -3,    -4,    -4,    22,    -4,    -4
};
...
{
       0,     0,     0,     0,     0,     2,     0,    11,     9,     0,
       0,     1,     0,     0,    10,     5,     8,     0,     0,     0,
       0,     0,     3,     4,     0,     7,     6
};
...
{
       9,    10,    11,    12,    13,    16,    25,    14,    12,    13,
      18,    19,     1,     6,     7,    21,     2,     3,    24,     1,
       0,     1,     0,     2,    17,    20,     3,    15,    12,    13,
       0,    26,    15,    12,    13,    12,    13,    16,    22,    12,
      13,    23,    12,    13
};
...
{
       0,     3,     7,     8,    15,    16,     3,     4,    17,    15,
      15,     0,     6,     7,    17,     5,     8,     8,    15,    15,
       7,    15,     5,     5,    15,     9,     9
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 33 "program9.y" /* yacc.c:1652  */
    { printf("Valid Identifiers 1\n");printf("Final result : valid Expression \n");exit(0);}
#line 1243 "y.tab.c" /* yacc.c:1652  */
    break;

  case 3:
#line 34 "program9.y" /* yacc.c:1652  */
    {printf("Final result :  valid Expression \n");exit(0);}
#line 1249 "y.tab.c" /* yacc.c:1652  */
    break;

  case 4:
#line 35 "program9.y" /* yacc.c:1652  */
    {printf("Final result : valid Expression \n"); exit(0);}
#line 1255 "y.tab.c" /* yacc.c:1652  */
    break;

  case 5:
#line 36 "program9.y" /* yacc.c:1652  */
    {printf("Final result : valid Expression \n"); exit(0);}
#line 1261 "y.tab.c" /* yacc.c:1652  */
    break;

  case 6:
#line 37 "program9.y" /* yacc.c:1652  */
    {printf("Final result : valid Expression \n"); exit(0);}
#line 1267 "y.tab.c" /* yacc.c:1652  */
    break;

  case 7:
#line 38 "program9.y" /* yacc.c:1652  */
    {printf("Final result : valid Expression \n"); exit(0);}
#line 1273 "y.tab.c" /* yacc.c:1652  */
    break;

  case 8:
#line 39 "program9.y" /* yacc.c:1652  */
    {printf("Final result : valid Expression \n"); exit(0);}
#line 1279 "y.tab.c" /* yacc.c:1652  */
    break;

  case 9:
#line 42 "program9.y" /* yacc.c:1652  */
    {printf("variable letter\n");}
#line 1285 "y.tab.c" /* yacc.c:1652  */
    break;

  case 10:
#line 45 "program9.y" /* yacc.c:1652  */
    {printf("letter term\n");}
...
#line 51 "program9.y" /* yacc.c:1918  */
